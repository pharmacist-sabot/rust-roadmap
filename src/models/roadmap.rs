...
impl NodeStatus {
  /// Cycle through statuses: Untouched → InProgress → Done → Skipped → Untouched
  pub fn cycle(self) -> Self {
    match self {
      NodeStatus::Untouched => NodeStatus::InProgress,
      NodeStatus::InProgress => NodeStatus::Done,
      NodeStatus::Done => NodeStatus::Skipped,
      NodeStatus::Skipped => NodeStatus::Untouched,
    }
  }

  pub fn label(self) -> &'static str {
    match self {
      NodeStatus::Untouched => "Untouched",
